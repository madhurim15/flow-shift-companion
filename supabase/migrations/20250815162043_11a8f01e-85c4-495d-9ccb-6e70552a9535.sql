...
CREATE INDEX idx_dice_roll_usage_user_id ON public.dice_roll_usage(user_id);
CREATE INDEX idx_dice_roll_usage_created_at ON public.dice_roll_usage(created_at);
CREATE INDEX idx_dice_roll_usage_cooldown ON public.dice_roll_usage(user_id, cooldown_expires_at);
CREATE INDEX idx_action_completions_user_id ON public.action_completions(user_id);
CREATE INDEX idx_action_completions_completed_at ON public.action_completions(completed_at);